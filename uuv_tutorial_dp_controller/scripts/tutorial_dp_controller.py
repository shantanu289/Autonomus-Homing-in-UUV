...
class TutorialDPController(DPControllerBase):
    ...
    def update_controller(self):
        ...
        tau = np.array([self.vel, 0, 0, 0, self.K_alpha*self._errors['rot'][1], self.K_beta*self._errors['rot'][2]])
	...
	#tau = np.array([self.vel, 0, 0, 0, self.K_alpha*self._errors['rot'][1], self.K_beta*self._errors['rot'][3])
